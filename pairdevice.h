...
void printAllPairs_full(double *all_pairs, int pair_count, int record_index, int pair_size){
...
*/
void savePair(double *all_pairs, double *recordlist, int record_count, int record_index, int record_attribute_indices[], int pair_count, int pair_index, int k){
...
*/
void copyPair(double *src, double *dest, int pair_count, int record_index, int pair_index, int k){
...
*/
void getPair(double *all_pairs, int pair_count, int record_index, int pair_index, int k, double *pair){
...
*/
void comparePairs(double *all_pairs, int pair_count, int record_index_1, int record_index_2, int pair_index, int k, int *equal){
